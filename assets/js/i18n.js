...
window.VOLTRAX.i18n = {
  ...
  "a11y.filterAvail": { en: "Filter by availability", es: "Filtrar por disponibilidad" },
  "a11y.filterType": { en: "Filter by type", es: "Filtrar por tipo" },
  "a11y.language": { en: "Language", es: "Idioma" },
  "a11y.menu": { en: "Menu", es: "Menú" },
  "a11y.navMobile": { en: "Mobile", es: "Menú móvil" },
  "a11y.navPrimary": { en: "Primary", es: "Principal" },
  "a11y.scroll": { en: "Scroll to inventory", es: "Bajar al inventario" },
  "a11y.home": { en: "Voltrax EV home", es: "Voltrax EV, inicio" },
  ...
  "badge.inStockN":    { en: "{n} in stock", es: "{n} en stock" },
  ...
  "hero.sub":      { en: "Voltrax EV is Panama's home for premium electric motorcycles. Sur-Ron, E Ride Pro, Yozma, Valtinsu and EBox, in stock and ready to ride from Costa del Este.",
                     es: "Voltrax EV es la casa de las motos eléctricas premium en Panamá. Sur-Ron, E Ride Pro, Yozma, Valtinsu y EBox, en stock y listas para rodar desde Costa del Este." },
  ...
  "form.errName":    { en: "Tell us your name so we know who's writing.", es: "Escribe tu nombre para saber quién nos escribe." },
  "form.errContact": { en: "Add a phone number or email so we can reply.", es: "Agrega un teléfono o correo para poder responderte." },
  "form.errContactFormat": { en: "That doesn't look like a phone number or email. Check it and try again.", es: "Eso no parece un teléfono ni un correo. Revísalo e inténtalo de nuevo." },
  ...
  "modal.availInN":  { en: "{n} in stock in Costa del Este", es: "{n} en stock en Costa del Este" },
